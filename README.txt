...
редактировать свой профиль, иммитировать покупку, получать "ключи". Этот pet-project cоздан мной с целью получения практики и выработки умений в программировании на Python c Django, а также REST framework.
...
-иммитировать покупку и получить ключ от игры (как на самой странице, так и получить ключ на странице профиля)
...
низкокачественнная верстка, полное отсутствие адаптации под мобильные устройства). Я признаю эти проблемы, но считаю что мне стоит сконцетрироваться на улучшении именно backend части проекта. Далее перечислю идеи по развитию проекта.
